-- Platform Pulse — Day 2 / Task 1 (Section 5.1)
-- Public announcements table with strict read/write RLS.
...
CREATE INDEX IF NOT EXISTS idx_public_announcements_featured_active
  ON public.public_announcements (is_featured, starts_at DESC)
  WHERE is_published = true;
