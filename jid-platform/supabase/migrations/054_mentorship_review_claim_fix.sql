-- PART A — Mentorship sprint retroactive fix (Staff Portal claim review)
-- Mentor approval MUST NOT flow through claim_requests or profiles.role.
-- The function in this repo is review_claim_request (not review_claim).
-- claim_type_enum is company | university only — never 'mentor'.
...
BEGIN
  ...
  IF p_decision = 'approve' THEN
    -- Mentor applications are approved via public.mentor_profiles (this sprint),
    -- NOT claim_requests. Never set profiles.role = 'mentor' here.
    v_new_role := CASE
