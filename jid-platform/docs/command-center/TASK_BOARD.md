...
| JID-110 GitHub Actions CI Quality Gate — IN PROGRESS | Repository-native PR and non-production push gate for hygiene, frozen install, zero-warning lint, type-check, safe tests, and production build; no deployment or secrets. RLS CI remains a scoped follow-up until the JID-107 disposable procedure is committed as a reusable, guaranteed-cleanup harness. | JID-101 and JID-111 safe gate; preserves JID-107 local baseline | P0 |
