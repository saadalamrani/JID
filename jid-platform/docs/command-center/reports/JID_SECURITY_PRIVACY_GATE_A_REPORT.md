...
- New branch: `codex/jid-security-privacy-gate-a-reconciled` (source).
- Expand/Contract shipping branch: `codex/jid-security-privacy-gate-a-expand-contract`.
- See `JID_SECURITY_PRIVACY_GATE_A_EXPAND_CONTRACT_REPORT.md` and the runbook for the zero-break rollout form.
...
- `supabase/migrations/20260805190100_catalog_review_auth_wrappers.sql` (restored byte-for-byte to canonical; BOM cleanup NOT shipped)
- `supabase/migrations/20260809065512_security_privacy_gate_a_expand.sql`
- `supabase/migrations/20260809065513_security_privacy_gate_a_contract.sql`
...
- `20260809065512_security_privacy_gate_a_expand.sql` and `20260809065513_security_privacy_gate_a_contract.sql` applied successfully.
