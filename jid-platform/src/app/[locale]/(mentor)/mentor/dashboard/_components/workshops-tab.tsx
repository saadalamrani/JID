  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_1.1fr]">
      <section className="rounded-xl border border-jid-line bg-white p-4">
        <h2 className="font-arabic text-sm font-semibold text-jid-ink">
        ...
        <div className="mt-4 space-y-3">
          <input
            ...
            className="w-full rounded-xl border border-jid-line px-3 py-2 font-arabic text-sm"
          />
          <input
            value={form.title_ar}
          ...
          <textarea
            ...
            className="w-full resize-none rounded-xl border border-jid-line px-3 py-2 font-arabic text-sm"
          />
          <input
            type="datetime-local"
      ...
      <section className="space-y-3">
        {workshops.length === 0 ? (
          <div className="rounded-xl border border-dashed border-jid-line py-12 text-center font-arabic text-sm text-jid-ink/55">
            {t('empty')}
          </div>
        ) : (
          workshops.map((workshop) => (
            <article key={workshop.id} className="rounded-xl border border-jid-line bg-white p-4">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h3 className="font-arabic text-sm font-semibold text-jid-ink">
                  ...
                  <p className="mt-1 font-arabic text-xs text-jid-olive">{workshop.status}</p>
                </div>
        ...
        <p className="font-arabic text-xs text-jid-ink/50">{t('chipHint')}</p>
      </section>
    </div>
  )
}
