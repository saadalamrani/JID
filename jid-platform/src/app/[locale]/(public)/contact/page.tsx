    ...
    <div dir={dir} lang={locale} className="container-jid py-12 md:py-16">
      ...
      <div className="mx-auto mt-12 grid max-w-5xl gap-10 lg:grid-cols-5 lg:gap-12">
        <aside className="space-y-4 lg:col-span-2">
          ...
          <p className="text-sm text-foreground/65">
            {t.rich('info.privacyLink', {
              pdplLink: (chunks) => (
                <Link href="/pdpl" className="font-medium text-primary underline-offset-2 hover:underline">
                  {chunks}
                </Link>
              ),
              privacyLink: (chunks) => (
        ...
        <section
          ...
          className="rounded-2xl border border-border bg-background/40 p-6 shadow-sm md:p-8 lg:col-span-3"
        >
          <h2 id="contact-form-heading" className="font-arabic text-xl font-semibold text-foreground">
            {t('form.heading')}
          </h2>
          <p className="mt-2 text-sm text-foreground/65">{t('form.subheading')}</p>
          <div className="mt-6">
            <ContactForm
              locale={locale}
