  ...
  return (
    <div dir={dir} lang={locale} className="container-jid space-y-16 py-12 md:py-16">
      ...
      <section aria-labelledby="about-mission-heading">
        <h2 id="about-mission-heading" className="font-arabic text-xl font-semibold text-foreground">
          {t('mission.title')}
        </h2>
        <p className="mt-3 max-w-3xl text-sm leading-relaxed text-muted-foreground">{t('mission.body')}</p>
      </section>

      <section aria-labelledby="about-values-heading">
        <h2 id="about-values-heading" className="font-arabic text-xl font-semibold text-foreground">
          {t('values.title')}
        </h2>
        <p className="mt-2 max-w-2xl text-sm text-foreground/65">{t('values.subtitle')}</p>
      ...
      >
        <h2 id="about-links-heading" className="font-arabic text-lg font-semibold text-foreground">
          {t('links.title')}
        </h2>
        <ul className="mt-4 flex flex-wrap gap-4 text-sm font-medium">
          ...
          <li>
            <Link href="/pdpl" className="text-primary hover:underline">
              {t('links.pdpl')}
            </Link>
          </li>
          <li>
