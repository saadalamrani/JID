  ...
  return (
    <div className="space-y-8">
      <div className="rounded-lg border-2 border-red-500 bg-red-50 p-5">
        <h1 className="text-xl font-bold text-red-800">{t('banner.title')}</h1>
        <p className="mt-2 text-sm text-red-700">{t('banner.description')}</p>
      </div>

      <header>
        <h2 className="text-2xl font-semibold text-jid-ink">{t('title')}</h2>
      ...
      <section>
        <h3 className="mb-3 text-lg font-semibold text-jid-ink">{t('historyTitle')}</h3>
