  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        <Label htmlFor="application-deadline" className="font-arabic text-jid-ink">
      ...
      <div className="space-y-2">
        <Label htmlFor="description-ar" className="font-arabic text-jid-ink">
        ...
        <textarea
          ...
          className={cn(
            'w-full rounded-md border border-jid-line bg-white px-3 py-2 font-arabic text-sm text-jid-ink',
            'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-jid-olive focus-visible:ring-offset-2',
