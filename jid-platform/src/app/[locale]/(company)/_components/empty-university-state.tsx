...
export function EmptyUniversityState({
  ...
  return (
    <section className="rounded-2xl border border-dashed border-accent/60 bg-background/60 p-8 text-center">
      ...
      <p className="mx-auto mt-2 max-w-xl text-sm text-foreground/70">{description}</p>

      <Link
        href={ctaHref}
        className="mt-5 inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white transition hover:opacity-90"
      >
