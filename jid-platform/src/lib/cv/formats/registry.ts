...
export const CV_FORMAT_REGISTRY: Record<CvExportFormatKey, CvFormatDefinition> = {
  ...
  harvard: {
    ...
    labelAr: 'هارفارد',
    labelEn: 'Harvard',
    descriptionAr: 'صيغة هارفارد — عمود واحد، بلا صور أو رسوم.',
    descriptionEn: 'Harvard-style resume — single column, no photos or graphics.',
    tier: 'plus',
    supportsReactPdf: true,
    defaultPageSize: 'LETTER',
  },
  global_ats: {
    ...
    labelAr: 'ATS عالمي',
    labelEn: 'Global ATS',
    descriptionAr: 'قالب موجّه لأنظمة الفرز الآلي — راجع النتيجة قبل الإرسال.',
    descriptionEn: 'Template oriented toward automated screening — review the result before sending.',
    tier: 'plus',
    supportsReactPdf: true,
    defaultPageSize: 'LETTER',
  },
