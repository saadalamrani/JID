...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 w-full items-center justify-center rounded-md bg-jid-beige p-1 text-jid-ink/70',
      className,
    )}
    {...props}
  />
