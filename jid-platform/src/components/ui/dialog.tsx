  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute end-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity duration-fast hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground',
