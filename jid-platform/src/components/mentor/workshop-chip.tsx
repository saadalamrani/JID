...
export function WorkshopChip({ workshop, className }: WorkshopChipProps) {
  ...
  return (
    <span
      className={cn(
        'inline-flex max-w-full items-center gap-1 rounded-full bg-gradient-to-r from-jid-gold-200 via-jid-gold to-jid-gold-400 px-2.5 py-1 text-[10px] font-semibold text-foreground shadow-sm',
        className,
      )}
    >
